...
```powershell
cd C:\Users\user\Documents\VSCode\ProcessGuard\processGuard-mcp
go mod tidy
...
Your current config: `config.json` already points to `C:\Users\user\Downloads\ProcessExplorer\procexp64.exe`
